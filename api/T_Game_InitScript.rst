...
[Missing documentation for “T:Game.InitScript”]

Inheritance Hierarchy
---------------------

System.Object  Object    Component      Behaviour        MonoBehaviour          Game.GameInitializer            Game.InitScript
...
.. code:: c#
   ...
   public class InitScript : GameInitializer

The InitScript type exposes the following members.
...
(Inherited from GameInitializer.)
...
(Overrides GameInitializer.InitializeBridge().)
...
(Overrides GameInitializer.InitializeClient().)
...
(Overrides GameInitializer.InitializeInstance().)
